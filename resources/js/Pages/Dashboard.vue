...
import UpdateFooter from "@/Pages/Dashboard/UpdateFooter.vue";
    ...
    <AppLayout title="Dashboard">
        <div class="py-12">
            <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                ...
                <SectionBorder />
                <h1 class="text-center font-semibold text-lg dark:text-white pb-5" id="services">
                    Service Section
                </h1>
                ...
                <SectionBorder />
                <h1 class="text-center font-semibold text-lg dark:text-white pb-5" id="pricing">
                    Pricing Section
                </h1>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <UpdatePricing v-for="price in prices" :key="price.id" :price="price" class="col-span-1" />
                </div>
